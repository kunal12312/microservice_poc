package com.example.kousik.demoswagger.controller;
...
import com.example.kousik.demoswagger.exception.ResourceNotFoundException;
import com.example.kousik.demoswagger.model.Employee;
import com.example.kousik.demoswagger.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	@ApiOperation(value = "Get an employee by City")
	@GetMapping(path="/employees1/{city}", produces = {MediaType.APPLICATION_XML_VALUE})
	public Employee getEmployeeByCity(
			@ApiParam(value = "Employee id from which employee object will retrieve", required = true)
			@PathVariable(value = "city") String city)
			throws ResourceNotFoundException {
		Employee employee = employeeRepository.findEmployeeByAddress_City(city);
			//	.orElseThrow(() -> new ResourceNotFoundException("Employee not found for this id :: " + employeeId));
		return employee;
	}
	...
	@GetMapping("/{id}/{id1}")
	public String updateEmployee(@PathVariable("id")String a,@PathVariable("id1")String b) {
